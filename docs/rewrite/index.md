...
- Rollback netplay is primary (relay + room codes, protocol v5, reconnect/resync hooks); remaining hardening work is focused on broader stress runs plus lockstep fallback maintenance.
