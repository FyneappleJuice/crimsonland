...
def test_mr_melee_plus_doubles_the_counterattack_damage() -> None:
    state = GameplayState()
    player = PlayerState(index=0, pos=Vec2(100.0, 100.0))
    player.perk_counts[int(PerkId.MR_MELEE)] = 1
    player.perk_counts[int(PerkId.MR_MELEE_PLUS)] = 1
    ...
    # Base Mr. Melee alone would leave 75.0 (25 dmg); ++ doubles it to 50.
