...
def test_long_distance_runner_plus_ramps_to_a_higher_cap() -> None:
    dt = 0.1
    steps = 20  # enough to reach the raised 3.4 cap
    ...
    player.perk_counts[int(PerkId.LONG_DISTANCE_RUNNER_PLUS)] = 1
    for _ in range(steps):
